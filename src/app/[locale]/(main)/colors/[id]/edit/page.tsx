    ...
    fetch(`/api/colors/${id}`)
      ...
      .then((data) => {
        setForm({
          ...
          cmykC: data.cmykC != null ? String(data.cmykC) : '',
          cmykM: data.cmykM != null ? String(data.cmykM) : '',
          cmykY: data.cmykY != null ? String(data.cmykY) : '',
          cmykK: data.cmykK != null ? String(data.cmykK) : '',
        ...
        <div className="bp-card__content">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
            ...
            <div className="bp-form-group">
              ...
              <input
                type="file" className="bp-input" accept="image/*"
